export const DarkVeilBackground = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      {/* Animated veil layers */}
      <div className="absolute inset-0">
        {/* Layer 1 - Large slow moving orb */}
        <div 
          className="absolute top-0 -left-48 w-96 h-96 rounded-full blur-3xl animate-float"
          style={{ 
        ...
        {/* Layer 2 - Medium orb */}
        <div 
          className="absolute top-1/4 right-0 w-80 h-80 rounded-full blur-3xl animate-float-delayed"
          style={{ 
        ...
        {/* Layer 3 - Small orb */}
        <div 
          className="absolute bottom-1/4 left-1/3 w-64 h-64 rounded-full blur-3xl animate-float"
          style={{ 
        ...
        {/* Layer 5 - Center ambient glow */}
        <div 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] rounded-full blur-3xl animate-pulse-slow"
          style={{ 
            background: 'radial-gradient(circle, rgba(139, 92, 246, 0.2) 0%, rgba(139, 92, 246, 0) 60%)'
          }}
        />

        {/* Additional purple glow top right */}
        <div 
          className="absolute top-1/3 right-1/3 w-72 h-72 rounded-full blur-3xl animate-float"
          style={{ 
